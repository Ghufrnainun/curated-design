...
- [Next UI / Hero UI](https://nextui.org/)
...
## C. Chinese / East Asian Enterprise
...
- [Zent](https://zent.youzan.com/)
- [HiUI](https://hiui.tech/)
...
- [Leafygreen (MongoDB)](https://www.mongodb.design/)
...
- [Wix RN UI Lib](https://wix.github.io/react-native-ui-lib/)
...
- [AnimateIcons](https://animateicons.in/)
- [Animated Icons by gorkem-bwl](https://animated-icons.vercel.app)
- [Line MD](https://icon-sets.iconify.design/line-md/)
- [Iconimate](https://iconimate.app/)
- [LivelyIcons](https://livelyicons.com/)
- [CSSVG Icons](https://icon.cssvg.com/)
- [React UseAnimations](https://react.useanimations.com/)
- [Motion Icons](https://motionicons.dev/)

## Component Libraries

- [COBE — 5KB WebGL Interactive Globe](https://github.com/shuding/cobe)
- [Morphicons — Universal Icon Morphing with Spring Physics](https://github.com/guillermolg00/morphicons)
- [PatternCraft - CSS Background Patterns](https://patterncraft.fun)
- [Beautiful UI - AI-Native Primitives](https://www.beautifului.dev/)
- [UI SFX — Semantic Sound Effects for Interfaces](https://github.com/romainsimon/uisfx)
- [Jakub Antalik — Animated React Components Suite](https://github.com/jakubantalik)
- [MotionVibe Studio — Browser Motion Editor](https://www.motionvibe-studio.com/)
- [Paper Shaders - Zero-Dependency Shaders](https://shaders.paper.design/)
